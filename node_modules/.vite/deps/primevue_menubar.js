...
var _hoisted_22 = ["onClick", "onMouseenter", "onMousemove"];
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("ul", mergeProps({
    ...
    }, null, 8, ["item", "root", "hasSubmenu", "label", "props"]))], 16, _hoisted_22), $options.isItemVisible(processedItem) && $options.isItemGroup(processedItem) ? (openBlock(), createBlock(_component_MenubarSub, {
      key: 0,
...
var _hoisted_12 = ["aria-haspopup", "aria-expanded", "aria-controls", "aria-label"];
function render2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", mergeProps({
    ...
    })], 16, _hoisted_12)) : createCommentVNode("", true)];
